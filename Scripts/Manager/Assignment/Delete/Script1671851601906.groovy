...
WebUI.click(findTestObject('Object Repository/Manager/Assignment/delete/span_Assignment'))
...
WebUI.click(findTestObject('Object Repository/Manager/Assignment/delete/div_Selamat datang   Steve HarveyLogin Seba_c0d723'))
...
WebUI.click(findTestObject('Object Repository/Manager/Assignment/delete/div_List Nasabah                           _972ccd'))

WebUI.click(findTestObject('Object Repository/Manager/Assignment/delete/a_Actions'))

WebUI.click(findTestObject('Object Repository/Manager/Assignment/delete/a_Delete_1_2'))
